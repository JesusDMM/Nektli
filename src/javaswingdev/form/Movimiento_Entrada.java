...
public class Movimiento_Entrada extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1015, 1094));
        setOpaque(false);
        setPreferredSize(new java.awt.Dimension(1015, 1094));
        ...
        add_tab.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 480, 140, 50));
        ...
        add_tab.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 480, 140, 50));

        jButton1.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 20)); // NOI18N
        jButton1.setText("Eliminar");
        jButton1.setOpaque(false);
        add_tab.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 480, 140, 50));
        add_tab.add(jDateChooser5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 380, 40));

        jLabel14.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 34)); // NOI18N
        jLabel14.setText("Fecha ");
        add_tab.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, -1, -1));
        add_tab.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 380, 40));

        jLabel3.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 34)); // NOI18N
        jLabel3.setText("Ciudad");
        add_tab.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, -1, -1));

        jLabel18.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 34)); // NOI18N
        jLabel18.setText("Latitud");
        add_tab.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 80, -1, -1));

        jLabel6.setFont(new java.awt.Font("Yu Gothic UI Light", 0, 34)); // NOI18N
        jLabel6.setText("Longitud");
        add_tab.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 270, -1, -1));
        add_tab.add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 140, 380, 40));
        add_tab.add(jTextField16, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 330, 380, 40));

        add(add_tab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 1100, 650));
